                    ...
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <form action="/products">
                            <div class="input-group">
                                <input type="text" id="keyword" name="keyword" class="form-control" placeholder="제품명으로 검색하세요">
                        ...
                        <div class="card product-item border-0 mb-4">
                            ...
                            <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                                ...
                                <div class="d-flex justify-content-center">
                                    <h6>${u.itemPrice}</h6><h6 class="text-muted ml-2"><del>${u.itemPrice}</del></h6>
                                </div>
                            </div>
                            <div class="card-footer d-flex justify-content-between bg-light border">
                                <a href="/products/${u.itemId}" class="btn btn-sm text-dark p-0"><i class="fas fa-eye text-primary mr-1"></i>자세히 보기</a>
                            </div>
                        </div>
                    </div>
                </c:forEach>
